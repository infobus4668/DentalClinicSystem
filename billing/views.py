...
def stock_adjustment_list_view(request):
    ...
    context = {
        ...
        'page_title': 'Stock Adjustment History'
    }
...
def create_stock_adjustment_view(request):
    ...
    context = {
        'form': form,
        'page_title': 'Create Manual Stock Adjustment'
    }
...
def delete_supplier_view(request, supplier_id):
    ...
    context = {
        'supplier': supplier,
        'page_title': f'Confirm Delete: {supplier.name}'
    }
...
def delete_service_view(request, service_id):
    ...
    context = {
        'service': service,
        'page_title': f'Confirm Delete: {service.name}'
    }
